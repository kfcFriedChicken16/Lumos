  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Redirect to dashboard immediately - let ProtectedRoute handle profile setup if needed
        router.push('/m/dashboard')
      } else {
        ...
        <div className="relative rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl shadow-[0_30px_80px_rgba(0,0,0,0.6)]">
          ...
          <div className="text-center pt-8 pb-6 px-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">
              Welcome Back to <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-cyan-300">LUMOS</span>
            </h1>
